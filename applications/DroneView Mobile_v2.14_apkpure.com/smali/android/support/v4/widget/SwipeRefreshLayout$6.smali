...
.method public run()V
    ...
    invoke-static {v0}, Landroid/support/v4/widget/SwipeRefreshLayout;->access$5(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/SwipeProgressBar;
    ...
    invoke-static {v1}, Landroid/support/v4/widget/SwipeRefreshLayout;->access$12(Landroid/support/v4/widget/SwipeRefreshLayout;)F

    move-result v1

    invoke-static {v0, v1}, Landroid/support/v4/widget/SwipeRefreshLayout;->access$13(Landroid/support/v4/widget/SwipeRefreshLayout;F)V

    .line 160
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout$6;->this$0:Landroid/support/v4/widget/SwipeRefreshLayout;

    # getter for: Landroid/support/v4/widget/SwipeRefreshLayout;->mShrinkTrigger:Landroid/view/animation/Animation;
    invoke-static {v0}, Landroid/support/v4/widget/SwipeRefreshLayout;->access$14(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/view/animation/Animation;
    ...
    invoke-static {v1}, Landroid/support/v4/widget/SwipeRefreshLayout;->access$15(Landroid/support/v4/widget/SwipeRefreshLayout;)I
    ...
    invoke-static {v1}, Landroid/support/v4/widget/SwipeRefreshLayout;->access$16(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/view/animation/Animation$AnimationListener;
    ...
    invoke-static {v1}, Landroid/support/v4/widget/SwipeRefreshLayout;->access$17(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/view/animation/DecelerateInterpolator;
    ...
    # getter for: Landroid/support/v4/widget/SwipeRefreshLayout;->mShrinkTrigger:Landroid/view/animation/Animation;
    invoke-static {v1}, Landroid/support/v4/widget/SwipeRefreshLayout;->access$14(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/view/animation/Animation;
