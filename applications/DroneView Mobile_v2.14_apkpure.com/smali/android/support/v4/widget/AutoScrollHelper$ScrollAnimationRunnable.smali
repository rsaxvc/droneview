...
.method public run()V
    ...
    invoke-static {v3}, Landroid/support/v4/widget/AutoScrollHelper;->access$0(Landroid/support/v4/widget/AutoScrollHelper;)Z
    ...
    invoke-static {v3}, Landroid/support/v4/widget/AutoScrollHelper;->access$1(Landroid/support/v4/widget/AutoScrollHelper;)Z
    ...
    invoke-static {v3, v4}, Landroid/support/v4/widget/AutoScrollHelper;->access$2(Landroid/support/v4/widget/AutoScrollHelper;Z)V
    ...
    invoke-static {v3}, Landroid/support/v4/widget/AutoScrollHelper;->access$3(Landroid/support/v4/widget/AutoScrollHelper;)Landroid/support/v4/widget/AutoScrollHelper$ClampedScroller;
    ...
    invoke-static {v3}, Landroid/support/v4/widget/AutoScrollHelper;->access$4(Landroid/support/v4/widget/AutoScrollHelper;)Z
    ...
    invoke-static {v3, v4}, Landroid/support/v4/widget/AutoScrollHelper;->access$5(Landroid/support/v4/widget/AutoScrollHelper;Z)V
    ...
    invoke-static {v3}, Landroid/support/v4/widget/AutoScrollHelper;->access$6(Landroid/support/v4/widget/AutoScrollHelper;)Z
    ...
    invoke-static {v3, v4}, Landroid/support/v4/widget/AutoScrollHelper;->access$7(Landroid/support/v4/widget/AutoScrollHelper;Z)V

    .line 704
    iget-object v3, p0, Landroid/support/v4/widget/AutoScrollHelper$ScrollAnimationRunnable;->this$0:Landroid/support/v4/widget/AutoScrollHelper;

    # invokes: Landroid/support/v4/widget/AutoScrollHelper;->cancelTargetTouch()V
    invoke-static {v3}, Landroid/support/v4/widget/AutoScrollHelper;->access$8(Landroid/support/v4/widget/AutoScrollHelper;)V
    ...
    invoke-static {v3}, Landroid/support/v4/widget/AutoScrollHelper;->access$9(Landroid/support/v4/widget/AutoScrollHelper;)Landroid/view/View;
