...
.method getScrapViewForPosition(II)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    # invokes: Landroid/support/v7/widget/RecyclerView;->getAnimatingView(II)Landroid/view/View;
...
.method public getViewForPosition(I)Landroid/view/View;
    ...
    # invokes: Landroid/support/v7/widget/RecyclerView;->findPositionOffset(I)I
    ...
    .line 2495
    .local v1, "id":J
    invoke-virtual {p0, v1, v2, v5}, Landroid/support/v7/widget/RecyclerView$Recycler;->getScrapViewForId(JI)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v6, v3}, Landroid/support/v7/widget/RecyclerView;->checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    invoke-virtual {v6, v3}, Landroid/support/v7/widget/RecyclerView;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
...
.method recycleViewHolder(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    # getter for: Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$State;
    ...
    # getter for: Landroid/support/v7/widget/RecyclerView$State;->mPreLayoutHolderMap:Landroid/support/v4/util/ArrayMap;
    ...
    # getter for: Landroid/support/v7/widget/RecyclerView$State;->mPostLayoutHolderMap:Landroid/support/v4/util/ArrayMap;
...
.method validateViewHolderForOffsetPosition(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)Z
    ...
    # getter for: Landroid/support/v7/widget/RecyclerView;->mAdapter:Landroid/support/v7/widget/RecyclerView$Adapter;
    invoke-static {v5}, Landroid/support/v7/widget/RecyclerView;->access$5(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$Adapter;

    move-result-object v5

    invoke-virtual {v5, p2}, Landroid/support/v7/widget/RecyclerView$Adapter;->getItemId(I)J
