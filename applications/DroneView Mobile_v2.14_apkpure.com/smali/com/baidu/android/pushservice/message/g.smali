...
# instance fields
.field private b:Lcom/baidu/android/pushservice/util/k;
...
.method private a(JLcom/baidu/android/pushservice/message/h;)[B
    ...
    new-instance v2, Lcom/baidu/android/pushservice/util/l;

    invoke-direct {v2, v1}, Lcom/baidu/android/pushservice/util/l;-><init>(Ljava/io/OutputStream;)V

    :try_start_0
    invoke-virtual {v2, p1, p2}, Lcom/baidu/android/pushservice/util/l;->a(J)V

    invoke-virtual {p3}, Lcom/baidu/android/pushservice/message/h;->a()I

    move-result v3

    invoke-virtual {v2, v3}, Lcom/baidu/android/pushservice/util/l;->b(I)V
    ...
    invoke-virtual {v2, v0}, Lcom/baidu/android/pushservice/util/l;->a([B)V
    ...
    :goto_0
    :try_start_2
    invoke-virtual {v2}, Lcom/baidu/android/pushservice/util/l;->a()V
    :try_end_2
...
.method private a(S[B)[B
    ...
    new-instance v3, Lcom/baidu/android/pushservice/util/l;

    invoke-direct {v3, v2}, Lcom/baidu/android/pushservice/util/l;-><init>(Ljava/io/OutputStream;)V
    ...
    :goto_0
    :try_start_0
    invoke-virtual {v3, p1}, Lcom/baidu/android/pushservice/util/l;->a(I)V

    sget-object v0, Lcom/baidu/android/pushservice/message/i;->f:Lcom/baidu/android/pushservice/message/i;

    invoke-virtual {v0}, Lcom/baidu/android/pushservice/message/i;->a()I
    ...
    invoke-virtual {v3, v0}, Lcom/baidu/android/pushservice/util/l;->a(I)V

    const/4 v0, 0x0

    invoke-virtual {v3, v0}, Lcom/baidu/android/pushservice/util/l;->b(I)V
    ...
    invoke-static {v0, v4}, Lcom/baidu/android/pushservice/util/s;->e(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-virtual {v3, v0}, Lcom/baidu/android/pushservice/util/l;->a([B)V
    ...
    invoke-virtual {v3, v1}, Lcom/baidu/android/pushservice/util/l;->b(I)V

    if-eqz p2, :cond_0

    invoke-virtual {v3, p2}, Lcom/baidu/android/pushservice/util/l;->a([B)V
    ...
    :goto_2
    :try_start_2
    invoke-virtual {v3}, Lcom/baidu/android/pushservice/util/l;->a()V
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_1
...
.method private d()Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/baidu/android/pushservice/util/s;->t(Landroid/content/Context;)I
...
.method private g()Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lcom/baidu/android/pushservice/util/s;->r(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public a([BI)Lcom/baidu/android/pushservice/message/f;
    ...
    new-instance v1, Lcom/baidu/android/pushservice/util/k;

    invoke-direct {v1, v4}, Lcom/baidu/android/pushservice/util/k;-><init>(Ljava/io/InputStream;)V

    iput-object v1, p0, Lcom/baidu/android/pushservice/message/g;->b:Lcom/baidu/android/pushservice/util/k;

    iget-object v1, p0, Lcom/baidu/android/pushservice/message/g;->b:Lcom/baidu/android/pushservice/util/k;

    invoke-virtual {v1}, Lcom/baidu/android/pushservice/util/k;->c()S

    move-result v2

    new-instance v3, Lcom/baidu/android/pushservice/message/f;

    invoke-direct {v3}, Lcom/baidu/android/pushservice/message/f;-><init>()V

    iput-short v2, v3, Lcom/baidu/android/pushservice/message/f;->a:S

    sget-object v1, Lcom/baidu/android/pushservice/message/i;->g:Lcom/baidu/android/pushservice/message/i;

    invoke-virtual {v1}, Lcom/baidu/android/pushservice/message/i;->a()I
    ...
    :cond_1
    iget-object v0, p0, Lcom/baidu/android/pushservice/message/g;->b:Lcom/baidu/android/pushservice/util/k;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lcom/baidu/android/pushservice/message/g;->b:Lcom/baidu/android/pushservice/util/k;

    invoke-virtual {v0}, Lcom/baidu/android/pushservice/util/k;->a()V
    ...
    invoke-virtual {v1}, Lcom/baidu/android/pushservice/util/k;->b()I
    ...
    iget-object v7, p0, Lcom/baidu/android/pushservice/message/g;->b:Lcom/baidu/android/pushservice/util/k;

    invoke-virtual {v7, v1}, Lcom/baidu/android/pushservice/util/k;->a([B)V
    ...
    invoke-virtual {v1, v0}, Lcom/baidu/android/pushservice/util/k;->a([B)V
...
.method public a(I)V
    ...
    invoke-static {v3}, Lcom/baidu/android/pushservice/j/d;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {v1}, Lcom/baidu/android/pushservice/message/f;-><init>()V
...
.method public b(Lcom/baidu/android/pushservice/message/f;)V
    ...
    invoke-static {v1}, Lcom/baidu/android/pushservice/message/i;->a(I)Lcom/baidu/android/pushservice/message/i;
    ...
    invoke-direct {v2}, Lcom/baidu/android/pushservice/message/f;-><init>()V
    ...
    invoke-direct {p0, v3, v4, v0}, Lcom/baidu/android/pushservice/message/g;->a(JLcom/baidu/android/pushservice/message/h;)[B
...
.method public c()V
    ...
    iput-boolean v2, v1, Lcom/baidu/android/pushservice/message/f;->d:Z

    invoke-virtual {v1, v2}, Lcom/baidu/android/pushservice/message/f;->a(Z)V
